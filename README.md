...
| **Using the ERC-20 Vault** (deposit / claim / withdraw / refund) | [`daml-packages/signet-vault-v1/README.md`](daml-packages/signet-vault-v1/README.md) — templates, choices, lifecycles, calldata shape                                                                                                                         |
