...
Used by [`signet-signer-v1`](../signet-signer-v1/README.md)'s `RequestId.daml`. Any off-Canton implementation that recomputes `requestId` must apply these encoders in the same order — see [Worked example](#worked-example-how-requestid-composes).
